  ...
  return (
    <>
      <div className="contactUs_img_main">
        {/* <Image className="contactUs_img" src="./img/mapimg.png" alt="map_image" width={100} height={100}/> */}
        <div className={`${"shape_main shape_main_location1"} ${data1}`}>
          ...
          <div className="shape_text_main">
            ...
            <p className="shape_p1">
              (Head Office)
              <br /> Plot Number 3,4 18 &<br />
              amp: 20A, Sector iIDC
              <br />
              SIDCUL
            </p>
        ...
        <div
          ...
          className="location_img_div location_img1"
        ></div>
        ...
        <div
          ...
          className="location_img_div location_img2"
        ></div>
        ...
        <div
          ...
          className="location_img_div location_img3"
        ></div>
      </div>
    </>
  );
